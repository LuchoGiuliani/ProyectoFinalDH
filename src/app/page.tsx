...
export default function Home() {
  return (
    <main className="background_hero relative">
      <Navbar />
      <div className="bg-[#0AEB8C] absolute bottom-0 w-full h-[25%] rounded-t-xl"></div>
      ...
      <section className=" flex flex-col justify-center md:flex-row w-full  gap-4 absolute bottom-28 ">
